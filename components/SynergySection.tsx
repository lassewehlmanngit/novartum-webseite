                 ...
                 {items.map((item, idx) => (
                    <div key={idx} className="relative group">
                       ...
                       <div className="bg-[#2a2e3b]/50 backdrop-blur-sm border border-slate-700 p-6 rounded-2xl hover:border-orange-500/50 hover:bg-[#2a2e3b] transition-all duration-300 flex flex-col sm:flex-row gap-6 items-start sm:items-center">
                          <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-600 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform shadow-lg">
